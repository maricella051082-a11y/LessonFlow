...
function renderStudentDashboard() {
    ...
    progress.tabIndex = 0; progress.setAttribute("role", "button"); progress.addEventListener("click", function() { showStudentSection("program"); }); progress.addEventListener("keydown", function(event) { if (event.key === "Enter" || event.key === " ") { event.preventDefault(); showStudentSection("program"); } });
